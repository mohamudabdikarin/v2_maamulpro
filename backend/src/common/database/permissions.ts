...
export const PERMISSION_MODULES: PermissionModuleDefinition[] = [
  ...
  { key: "workforce_contracts", label: "Workforce Contracts", workspace: "construction", permissions: [...crud("workforce_contracts"), _PERMISSIONS.WORKFORCE_CONTRACTS_PAY], checkboxActions: PERMISSION_ACTIONS },
  ...
  { key: "activity_logs", label: "Activity Logs", workspace: "core", permissions: [_PERMISSIONS.ACTIVITY_LOGS_READ, _PERMISSIONS.ACTIVITY_LOGS_DELETE] },
  ...
  { key: "payroll", label: "Payroll", workspace: "core", permissions: [_PERMISSIONS.PAYROLL_READ, _PERMISSIONS.PAYROLL_MANAGE, _PERMISSIONS.PAYROLL_APPROVE, _PERMISSIONS.PAYROLL_PAY] },
