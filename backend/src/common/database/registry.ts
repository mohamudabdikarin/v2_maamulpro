...
export const PERMISSIONS = {
  ...
  WORKFORCE_CONTRACTS_PAY: "workforce_contracts.pay",
...
const CONSTRUCTION_ALL: Permission[] = [
  ...
  PERMISSIONS.WORKFORCE_CONTRACTS_PAY,
...
export const LEGACY_PERMISSION_ALIASES: Record<string, Permission[]> = {
  ...
  "accounting:manage": [PERMISSIONS.ACCOUNTING_READ, PERMISSIONS.ACCOUNTING_MANAGE, PERMISSIONS.ACCOUNTING_POST, PERMISSIONS.ACCOUNTING_APPROVE],
};
...
export const ROLE_PERMISSIONS: Record<AppRole, Permission[]> = {
  ...
  ADMIN: ADMIN_ALL.filter((p) => p !== PERMISSIONS.ACTIVITY_LOGS_READ && p !== PERMISSIONS.ACTIVITY_LOGS_DELETE),
  MANAGER: [
    PERMISSIONS.ACCESS_CONSTRUCTION,
    PERMISSIONS.ACCESS_REAL_ESTATE,
    PERMISSIONS.ACCESS_MATERIAL_MANAGEMENT,
    ...
    PERMISSIONS.ANALYTICS_REAL_ESTATE_READ,
    PERMISSIONS.ANALYTICS_MATERIAL_READ,
    PERMISSIONS.DASHBOARD_EXECUTIVE_READ,
