# MaamulPro v2 Workspace Rules

You are an AI assistant working on the MaamulPro v2 project. To minimize token usage and avoid hitting usage limits, strictly adhere to the following rules:
...
- **DO NOT** run widespread `grep_search` or read entire source code trees to find files. Always refer to `ARCHITECTURE.md` in the root directory for a map of the repository before exploring.
