...
type Transaction = { id: string; version: number; referenceId: string; type: 'INCOME' | 'EXPENSE'; status: string; description: string; amount: number; date: string; notes?: string; categoryId?: string; projectId?: string; propertyId?: string; materialId?: string; category?: { name: string }; project?: { name: string }; property?: { title: string }; material?: { name: string } };
