    ...
    return <AppShell>
        ...
        <Modal open={Boolean(deleteTarget)} onClose={() => setDeleteTarget(null)} title="Delete transaction">
            <div className="space-y-4">
                <p className="text-white-dark">This action permanently deletes transaction <strong>{deleteTarget?.referenceId}</strong> and cannot be undone.</p>
