...
const AccountingPeriodsPage = () => {
    ...
    return <AppShell><PageHeader eyebrow="Accounting controls" title="Accounting periods" description="Lock completed periods to prevent late or accidental journal postings." />
