...
const PropertySalesPage = () => {
    ...
    return <AppShell><PageHeader eyebrow="Real estate revenue" title="Property sales" description="Sales pipeline, settlement status, collections and outstanding balances." actions={<Link className="btn btn-primary" to="/app/real-estate/deals/new">New sale</Link>} />
