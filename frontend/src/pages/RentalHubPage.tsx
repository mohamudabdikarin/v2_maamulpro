...
const RentalHubPage = () => {
    ...
    useEffect(() => { load(); }, []);
    return <AppShell><PageHeader eyebrow="Rental management" title="Rentals" description="Tenants, leases, renewals, payment obligations and collections in one workspace." actions={<><Link className="btn btn-outline-primary" to="/app/real-estate/tenants">Tenants</Link><Link className="btn btn-primary" to="/app/real-estate/rental-contracts">New lease</Link></>} />
