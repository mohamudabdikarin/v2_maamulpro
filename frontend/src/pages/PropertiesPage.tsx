...
const PropertiesPage = () => {
    ...
    return <AppShell>
        <PageHeader eyebrow="Real estate" title="Properties" description="Portfolio listings, valuation, occupancy and transaction history." actions={<Link className="btn btn-primary" to="/app/real-estate/properties/new">Add property</Link>} />
