...
const routes = [
    ...
    { path: '/app/materials/suppliers', element: <CrudPage title="Suppliers" description="Procurement suppliers, balances and contact details." endpoint="/api/materials/suppliers" createPermission="suppliers.create" updatePermission="suppliers.update" deletePermission="suppliers.delete" fields={supplierFields} />, layout: 'blank', permission: 'suppliers.read' },
    ...
    { path: '/app/materials/purchases', element: <CrudPage title="Purchase Orders" description="Orders with received-stock, weighted-cost and supplier-ledger synchronization." endpoint="/api/materials/purchases" createPermission="purchases.create" updatePermission="purchases.update" deletePermission="purchases.delete" canEdit={false} transitions={[
